...
## Current Status (v1.0.9 Planning)

- Latest released tag: `v1.0.8` (`2026-03-23`).
- Active execution lane: `v1.0.9` (`M7` anti-abuse + UX/performance reliability hardening) with one-milestone-per-version discipline.
