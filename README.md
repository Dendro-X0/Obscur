...
## Current Status (v1.0.8 Planning)

- Latest released tag: `v1.0.7` (`2026-03-23`).
- Active execution lane: `v1.0.8` (`M6` real-time voice beta slice) with one-milestone-per-version discipline.
