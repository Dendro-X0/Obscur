...
Updated: `2026-07-02T14:35:50.282272200+00:00`
Issues (deduped view): **15** (+ 19 unmapped captures collapsed)
...
| --- | ---: | --- | ---: | --- | --- |
| group-thread-relay-ingest | 14 | p0 | 7 | chain-o4-group-ingest-2026-07-02 | `.codectx/verify/client-sessions/csess-6f1a35b7762b/captures/cap-11af3adb8200/screenshot.png` |
...
| groups-ledger-validation | 26 | p1 | — | — | `.codectx/verify/client-sessions/csess-56331621b1d9/captures/cap-21d585b2704b/screenshot.png` |
| dm-normalize-is-outgoing-mismatch | 1 | p1 | — | — | `.codectx/verify/faults/fault-0f46250f.json` |
| dm-ui-split-brain | 3 | p2 | 6 | chain-dm-split-brain-2026-07-02 | `.codectx/verify/client-sessions/csess-510a62aba320/captures/cap-ea9f85f6b470/screenshot.png` |
...
| _(unmapped faults)_ | 21 | — | — | — | see faults/*.json; run RIW-8 signal extract |
...
| --- | --- | ---: | --- | --- | --- |
| chain-o4-group-ingest-2026-07-02 | group-thread-relay-ingest | 22 | open | partial_accepted | — |
| chain-transport-soak-2026-07-02 | relay-partial-stack-desktop-only | 2 | open | partial_accepted | — |
| chain-dm-split-brain-2026-07-02 | dm-ui-split-brain | 7 | open | partial_accepted | — |
