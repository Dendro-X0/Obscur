...
const getVariantClassName = (variant: ButtonVariant): string => {
    ...
    if (variant === "outline") {
        return "border border-black/10 bg-transparent text-zinc-900 hover:bg-black/5 dark:border-white/10 dark:text-zinc-100 dark:hover:bg-white/10";
    }
    if (variant === "ghost") {
        return "bg-transparent text-zinc-900 hover:bg-black/5 dark:text-zinc-100 dark:hover:bg-white/10";
    }
    return "bg-gradient-primary text-white shadow-md shadow-purple-500/20 hover:shadow-lg hover:shadow-purple-500/30 dark:shadow-purple-900/40";
};
