        ...
        <div className="space-y-4 text-left">
          ...
          <div className="rounded-[24px] border border-violet-500/20 bg-violet-500/5 px-4 py-4">
            <div className="text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-300">
              {t("profiles.portability.restore.importFromFile.title")}
            </div>
            <p className="mt-2 text-xs leading-relaxed text-zinc-600 dark:text-zinc-400">
              {t("profiles.portability.restore.importFromFile.desc")}
            </p>
            <Button
              type="button"
              variant="outline"
            ...
            >
              {importFlow.isImporting ? (
                ...
                <span className="inline-flex items-center gap-2">
                  ...
                  {t("profiles.portability.restore.chooseBackupFile")}
                </span>
              )}
            </Button>
            <input
