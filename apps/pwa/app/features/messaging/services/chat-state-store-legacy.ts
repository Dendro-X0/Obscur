/**
 * Chat state localStorage mirror — UI persistence until dm-kernel owns read models.
 * Canonical features implementation (w40); import only through chat-state ports.
 */
...
import { loadPersistedChatState, normalizePersistedGroupState, savePersistedChatState } from "@/app/features/messaging/utils/persistence";
...
export { CHAT_STATE_REPLACED_EVENT } from "@/app/features/messaging/services/chat-state-store-types";
export type { ChatStateReplacedEventDetail } from "@/app/features/messaging/services/chat-state-store-types";
