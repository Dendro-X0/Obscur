...
import { getMessageDirectionCounts, hasPartialDirectionCoverage } from "@/app/features/messaging/services/dm-thread-read-model";
import type {
  AssembleDmHydrateThreadReadModelParams,
  AssembleDmHydrateThreadReadModelResult,
} from "@/app/features/messaging/services/thread-history/hydrate-read-model-types";
...
export const assembleLegacyDmHydrateThreadReadModel = (
...
/** @deprecated Use assembleLegacyDmHydrateThreadReadModel */
export const assembleDmHydrateThreadReadModel = assembleLegacyDmHydrateThreadReadModel;
