...
export const loadLegacyConversationWindow = async (params: Readonly<{
...
/** @deprecated Use loadLegacyConversationWindow */
export const loadConversationWindow = loadLegacyConversationWindow;
...
export const loadLegacyConversationWindowAcrossAliases = async (params: Readonly<{
  ...
  const rowsByConversationId = await Promise.all(conversationIds.map(async (conversationId) => ({
    conversationId,
    rows: await loadLegacyConversationWindow({
      conversationId,
      limit: params.limit,
...
/** @deprecated Use loadLegacyConversationWindowAcrossAliases */
export const loadConversationWindowAcrossAliases = loadLegacyConversationWindowAcrossAliases;

export const scanLegacyDisplayableHistoryWindow = async (params: Readonly<{
  conversationIds: ReadonlyArray<string>;
...
/** @deprecated Use scanLegacyDisplayableHistoryWindow */
export const scanDisplayableHistoryWindow = scanLegacyDisplayableHistoryWindow;

/** Initial hydrate: latest window + scan passes + soft cap slice for downstream authority. */
export const loadLegacyInitialDmHydrationIndexedWindow = async (params: Readonly<{
  conversationIds: ReadonlyArray<string>;
...
/** @deprecated Use loadLegacyInitialDmHydrationIndexedWindow */
export const loadInitialDmHydrationIndexedWindow = loadLegacyInitialDmHydrationIndexedWindow;
