// @ts-nocheck
/**
 * @deprecated Legacy v1 DM controller — NOT used by the desktop runtime shell.
 * Production uses `controllers/v2/dm-controller.ts` via `hooks/use-enhanced-dm-controller.ts` (re-export).
 * Retained for historical integration tests only; do not import from new code.
 *
