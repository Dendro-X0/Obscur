/**
 * PWA enhanced relay pool — React hook + WebSocket runtime until transport-engine owns the pool.
 * @see docs/program/obscur-backend-engine-roadmap.md §transport-engine
 */


import type { NostrEvent } from "@dweb/nostr/nostr-event";
import { createRelayWebSocket } from "@/app/features/relays/hooks/create-relay-websocket";
import type { RelayConnection } from "@/app/features/relays/hooks/relay-connection";
import type { RelayConnectionStatus } from "@/app/features/relays/hooks/relay-connection-status";
import { RelayHealthMonitor, relayHealthMonitor, type RelayHealthMetrics } from "@/app/features/relays/hooks/relay-health-monitor";
import { SubscriptionManager } from "@/app/features/relays/hooks/subscription-manager";
...
export { useEnhancedRelayPoolRuntime as useLegacyEnhancedRelayPool } from "./use-enhanced-relay-pool-runtime";

/** @deprecated Use useLegacyEnhancedRelayPool */
export { useEnhancedRelayPoolRuntime as useEnhancedRelayPool } from "./use-enhanced-relay-pool-runtime";
