...
type GroupPageProps = Readonly<{
  params: Readonly<{ groupId: string }>;
}>;

export default function GroupPage(props: GroupPageProps): React.JSX.Element {
  const router = useRouter();
  const parsed = useMemo(() => parseNip29GroupIdentifier(props.params.groupId), [props.params.groupId]);
