...
/**
 * W60 frozen archive — historical contract pin for pre-deletion standalone publish semantics.
 * Production owner removed in W61+; engine-lab contracts read this path after subtraction.
 */
