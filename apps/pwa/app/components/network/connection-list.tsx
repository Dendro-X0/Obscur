        ...
        <div className="space-y-6">
            ...
            {contacts.length === 0 ? (
                <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-zinc-200 py-12 text-center dark:border-zinc-800">
                    ...
                    <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-50">{t("network.noContactsFound")}</h3>
                    <p className="mt-1 text-xs text-zinc-500">{t("network.noContactsDesc")}</p>
