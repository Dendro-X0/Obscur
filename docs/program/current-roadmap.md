...
1. **[v1.5.0 Community Sync Reliability Overhaul](../archive/consolidated/v1.5.0-community-sync-reliability-overhaul.md)** ← **ACTIVE PRIMARY / RELEASE BLOCKER**
   - Community runtime owner replacement
   - Same-process A/B multi-profile replay gates
   - Restore/static-history boundary hardening
   - Durable private leave intent and relay publish outbox

2. **[v1.4.7 Community Modes & Convergence Roadmap](../archive/consolidated/v1.4.7-community-modes-and-convergence.md)** ← **SUPERSEDED BY v1.5.0 BLOCKER LANE**
...
3. **[v1.4.0 CRDT Protocol Rewrite Roadmap](../archive/consolidated/v1.4.0-crdt-protocol-rewrite-roadmap.md)** ← **ARCHIVED (Released)**
   - Superseded by v1.4.7 plan
   - CRDT-native architecture delivered in v1.4.0-v1.4.6

### Archived v1.4.0 Plans (For Reference)
2. [v1.4.0 In-Place Rewrite and Resilience Plan](../archive/consolidated/v1.4.0-in-place-rewrite-and-resilience-plan.md) ← **SUPERSEDED**
3. [v1.4.0 Specification and Test Matrix](../archive/consolidated/v1.4.0-specification-and-test-matrix.md)
4. [v1.4.0 Closeout and Documentation Consolidation Contract](../archive/consolidated/v1.4.0-closeout-and-doc-consolidation.md)

### Previous Release Plans
5. [v1.3.8 Roadmap and Execution Contract](../archive/consolidated/v1.3.8-hybrid-offline-streaming-update-plan.md)
6. [v1.3.8 Offline UI Asset Inventory and Local-First Policy](../archive/consolidated/v1.3.8-offline-ui-asset-inventory.md)
7. [v1.3.8 Streaming Update Contract](../archive/consolidated/v1.3.8-streaming-update-contract.md)
...
8. v1.5.0 is now blocked on same-process A/B proof that community, sync, notification, call, and profile-scoped state cannot drift across accounts.
...
3. `docs/archive/rewrite-shelf/28-in-place-architecture-rewrite-plan.md`
4. `docs/archive/rewrite-shelf/29-in-place-modularization-and-test-contract.md`
5. `docs/archive/rewrite-shelf/30-fragility-analysis-and-safe-iteration-contract.md`
6. `docs/archive/rewrite-shelf/31-long-term-resilience-and-context-limits-playbook.md`
7. `docs/archive/rewrite-shelf/32-community-system-reset-and-alternative-solutions.md`
8. `docs/archive/rewrite-shelf/33-community-modes-and-relay-guarantees.md`
9. `docs/archive/consolidated/v1.5.0-community-sync-reliability-overhaul.md`
10. `docs/archive/rewrite-shelf/38-v1.5-community-runtime-owner-and-projection-spec.md`
11. `docs/archive/rewrite-shelf/39-v1.5-same-process-ab-replay-and-release-gate-spec.md`
...
6. make account A/account B same-process replay a blocking release gate for v1.5.0.
