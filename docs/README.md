...
| 6 | [v1.8.10 scope](./program/v1.8.10-scope.md) | **Current** patch — D2 + Lane P |
| 6a | [v1.8.9 scope](./program/v1.8.9-scope.md) | **Shipped** — D1 + D3 |
...
| [**v1.8.x release train**](./program/v1.8.x-release-train.md) | Active patch — **v1.8.10** |
| [**v1.8.9+ managed workspace**](./program/v1.8.9-plus-managed-workspace-roadmap.md) | D2 (v1.8.10); bots (v1.8.11+) |
