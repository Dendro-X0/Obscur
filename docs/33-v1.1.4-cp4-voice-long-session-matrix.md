...
Compact CP4 checkpoint gate probe (recommended quick release verdict):
...
Compact CP4 release-readiness bundle (recommended one-copy operator handoff):
...
Compact CP4 release-readiness gate probe:
...
Compact CP4 release-evidence packet (recommended one-copy operator handoff):
...
Compact CP4 release-evidence gate probe:
...
Compact v1.2.0 closeout bundle (recommended one-copy CP4 closeout handoff):
...
Compact v1.2.0 closeout gate probe:
...
6. `releaseReadinessGate`:
: aggregate release-readiness verdict (when using release-readiness helper).
7. `evidenceGate`:
: aggregate release packet verdict (when using release-evidence helper).
8. `m6 capture` CP4 event slices are present:
