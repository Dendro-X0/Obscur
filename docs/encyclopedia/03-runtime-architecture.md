...
Cross-reference:
- Core contract and anti-drift checklist live in `docs/encyclopedia/12-core-architecture-truth-map.md`.
- Startup/relay failure classes and capture order live in `docs/encyclopedia/13-relay-and-startup-failure-atlas.md`.
