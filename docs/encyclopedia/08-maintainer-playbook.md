...
### v1.5.0 architecture refactor period

While the v1.5.0 **architecture refactor and upgrade** is in flight:

1. Follow **`docs/program/v1.5.0-refactor-verification-and-docs-policy.md`** for **deferred client/manual testing** and the **checkpoint → docs** checklist (handoff, `docs/program/v1.5.0-refactor-checkpoints.md`, queue bumps, `pnpm docs:check`).
2. Treat **`docs/program/v1.5.0-architecture-refactor-queue.md`** as the ordered backlog (R1–R4); do not substitute ad-hoc smoke for slice exit without updating that doc and the truth map gate.
