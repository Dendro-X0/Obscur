...
const RULES = [
  ...
  { module: "thread-history/hydrate-read-model", names: ["assembleDmHydrateThreadReadModel", "assembleLegacyDmHydrateThreadReadModel"] },
...
const OWNER_RELATIVE_PATHS = new Set([
  ...
  "messaging/services/thread-history/hydrate-read-model.ts",
