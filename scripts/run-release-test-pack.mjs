...
const main = () => {
  ...
  runPwaVitest([
    ...
    "app/features/vault/services/vault-message-scan.test.ts",
    "app/features/groups/components/community-invite-status-banner.test.tsx",
    "app/shared/schedule-idle-work.test.ts",
    ...
    "app/features/groups/services/community-mode-contract.test.ts",
    "app/features/groups/services/community-steward-policy.test.ts",
    ...
    "app/features/groups/services/community-descriptor-mutation-owner.test.ts",
    ...
    "app/features/account-sync/hooks/use-account-projection-runtime.test.ts",
